...
function Scoreboard({ roomCode, matchState, isHost, nextGame }) {
    const { scores, players, totalGames, currentGame } = matchState;

    // Create a sorted list of players with their scores
        ...
        <div className="bg-gray-800 p-8 rounded-xl shadow-lg w-full max-w-2xl text-center border-2 border-yellow-600">
            ...
            {isHost && (
                <div className="mt-8 border-t border-gray-700 pt-6">
                    ...
                    {currentGame < totalGames ? (
                        ...
                        >
                            Next Game ({currentGame + 1} / {totalGames})
                        </button>
                    ) : (
                        <button
            ...
            {!isHost && (
                <p className="text-center text-gray-400 mt-6 text-lg">
                    Waiting for the host to proceed to the next game...
                </p>
            )}
        </div>
    );
